	        ...
	        compile: function () {
	            return {
	                pre: function ($scope, $elm, $attrs, uiGridCtrl) {
	                    ...
	                    $scope.uiGridAutoFitColumnsService = uiGridAutoFitColumnsService;
	                    //$scope.$on('manualGridUpdate', function ($scope) { debugger; $scope.currentScope.uiGridAutoFitColumnsService.initializeGrid($scope.currentScope.mapCtrl.gridApi.grid); });
	                }
	            };
	        }
	    };
